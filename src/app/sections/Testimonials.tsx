...
const testimonials = [
  {
    ...
    content:
      'MaticRent made my Bali trip unforgettable. The scooter was in perfect condition, and the delivery service saved me so much time! Highly recommend to anyone visiting.',
    rating: 5,
  },
  {
    id: 2,
    ...
    content:
      "I rent from MaticRent every month. Reliable scooters, fair prices, and the team is always helpful. It's become an essential part of my nomadic lifestyle.",
    rating: 5,
  },
  {
    id: 3,
    ...
    content:
      'First time riding a scooter and MaticRent made it so easy. They even gave me a quick lesson. Felt safe the entire trip! Will definitely use again.',
    rating: 5,
  },
  {
    id: 4,
    ...
    content:
      'Need a quick way to get around the city for meetings. MaticRent\'s weekly plan is perfect for my needs. Professional service every time.',
    rating: 5,
  },
  {
    id: 5,
    ...
    imageHint: 'woman outdoors',
    content:
      'Rented the NMAX for a weekend trip. Smooth ride, great fuel efficiency, and zero issues. Will definitely rent again for my next adventure!',
    rating: 5,
  },
]
    ...
    >
      ...
      <div className="relative w-full px-4 sm:px-6 lg:px-12 xl:px-20">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          >
            What Our <span className="text-brand-yellow">Riders Say</span>
          </h2>
        </div>
            ...
            <div className="pt-4">
              ...
              <div className="flex items-center gap-4">
                <Image
                  ...
                  width={56}
                  height={56}
                  data-ai-hint={testimonials[activeIndex].imageHint}

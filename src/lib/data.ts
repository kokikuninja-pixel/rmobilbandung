...
export const testimonials: Testimonial[] = [
    {
        ...
        comment: "Proses sewa di RMJP cepat dan motornya dalam kondisi prima. Sangat membantu mobilitas saya selama dinas di Jakarta. Pasti akan sewa di sini lagi!"
    },
    {
        name: "Citra Dewi",
        role: "Travel Blogger",

...
const stats = [
  ...
  { icon: Users, value: 50, suffix: '+', label: 'Premium Scooters' },
  { icon: Clock, value: 10, suffix: 'K+', label: 'Happy Customers' },
      ...
      <div className="w-full px-4 sm:px-6 lg:px-12 xl:px-20">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <div className="relative z-10 group">
              <Image
                ...
                width={800}
                height={600}
                data-ai-hint="scooter lifestyle"
          ...
          <div className="space-y-8">
            ...
            >
              We're not just a rental service – we're your partner in urban
              exploration. With over 5 years of experience, 50+ premium scooters,
              and 10,000+ happy customers, we've perfected the art of hassle-free
              scooter rentals.
            </p>

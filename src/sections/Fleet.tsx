...
const scooters = [
  {
    ...
    price: 15,
    image: '/images/vario160.jpg',
    tag: 'Most Popular',
    tagColor: 'bg-brand-yellow',
    specs: { cc: 160, efficiency: '45 km/l', tank: '11L' },
    features: ['Smart Key', 'LED Lights', 'Spacious Storage'],
  },
  {
    id: 2,
    name: 'Yamaha NMAX 155',
    price: 18,
    image: '/images/nmax155.jpg',
    tag: 'Premium',
    tagColor: 'bg-brand-black text-white',
    specs: { cc: 155, efficiency: '40 km/l', tank: '7.1L' },
    features: ['ABS Brakes', 'Traction Control', 'Full Digital Display'],
  },
  {
    id: 3,
    name: 'Honda PCX 160',
    price: 20,
    image: '/images/pcx160.jpg',
    tag: 'Best Value',
    tagColor: 'bg-green-500 text-white',
    specs: { cc: 160, efficiency: '43 km/l', tank: '8.1L' },
    features: ['Idling Stop', 'CBS Brakes', 'USB Charger'],
  },
  {
    id: 4,
    name: 'Yamaha Aerox 155',
    price: 16,
    image: '/images/aerox155.jpg',
    tag: 'Sporty',
    tagColor: 'bg-blue-500 text-white',
    specs: { cc: 155, efficiency: '42 km/l', tank: '5.5L' },
    features: ['Sport Design', 'Mono Shock', 'Wide Tires'],
  },
  {
    id: 5,
    name: 'Honda Beat 110',
    price: 12,
    image: '/images/beat110.jpg',
    tag: 'Economy',
    tagColor: 'bg-orange-500 text-white',
    specs: { cc: 110, efficiency: '50 km/l', tank: '4.2L' },
    features: ['Lightweight', 'Easy Handling', 'Fuel Efficient'],
  },
]
    ...
    >
      ...
      <div className="w-full px-4 sm:px-6 lg:px-12 xl:px-20">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          >
            Choose Your <span className="text-brand-yellow">Ride</span>
          </h2>
          <p
          ...
          >
            From city commuters to weekend explorers, find the perfect scooter
            for your journey.
          </p>
        </div>
